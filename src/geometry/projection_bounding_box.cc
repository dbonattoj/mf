...
projection_bounding_box projection_bounding_box::symmetric_orthogonal
...
projection_bounding_box projection_bounding_box::symmetric_orthogonal_x
(float width, float aspect_ratio, float near_z, float far_z) {
	return projection_bounding_box(
		{ -width/2.0f, +width/2.0f },
...
projection_bounding_box projection_bounding_box::symmetric_orthogonal_y
(float height, float aspect_ratio, float near_z, float far_z) {
	return projection_bounding_box(
...
projection_bounding_box projection_bounding_box::asymmetric_orthogonal
(distance_pair x, distance_pair y, float near_z, float far_z) {
	return projection_bounding_box(x, y, near_z, far_z);
}


projection_bounding_box::projection_bounding_box(distance_pair x, distance_pair y, float near_z, float far_z) :
bounding_box(
	Eigen::Vector3f(x.first, y.first, near_z),
	Eigen::Vector3f(x.second, y.second, far_z)
) {}
